...
export default function ClientSidebar({ sidebarOpen, setSidebarOpen }) {
  ...
  const menu = [
    ...
    { name: "Request Lawyer", icon: UserPlus, path: "/client/select-lawyer" },
    { name: "My Requests", icon: ClipboardList, path: "/client/requests" },
    { name: "My Cases", icon: Folder, path: "/client/cases" },
  ];
